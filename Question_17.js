...
//result list to store data
var obj = [];

//iteration for json file
for(i in jsonObject.articles){
    var sub = {'autor':jsonObject.articles[i].author,'title':jsonObject.articles[i].title,'description':jsonObject.articles[i].description};
    obj.push(sub);
}
